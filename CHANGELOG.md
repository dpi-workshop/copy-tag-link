...
- Added a file-first CTL package contract.
- Added HTML and PDF demo workflows.
- Added OKF-compatible Markdown card export.
- Added public source intake demos for RSS, websites, GitHub, YouTube metadata, and Reddit public JSON.
